    ...
    <main>
      ...
      <BoxStyled maxWidth={'1200px'} marginX={'auto'} paddingY={4}>
        <Typography variant='body1' sx={{ textAlign: 'justify' }} fontWeight={'bold'}>
          Ofrecemos servicios de mobilidad grupal a traves de nuestros autobuses y camionetas con conductores certificados, hacia cualquier destino dentro de México.
